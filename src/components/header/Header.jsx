...
import { headerLeftList, headerList } from "../static/Static";
import "./header.scss";
    ...
    <header className="header">
      <nav className="navbar container df">
        <div className="header__logo">
          ...
          >
            <rect id="Clear_space" width="120" height="32" fill="white"></rect>
            <path
              id="Logo_ratio"
        ...
        <div className="header__btns df">
          <ul className="header__btns__left__list df">
            {headerLeftList.map((item, indx) => {
              return (
                <li className="header__btns__left__item" key={indx}>
                  <a href="">{item}</a>
                </li>
              );
            })}
          </ul>
          <div className="header__btns__right__icons">
            <IoSearch />
